...
public class GroundPokemon extends Pokemon {
    ...
    public GroundPokemon(String name, double health, int attack, int defense, int special, Move move1, Move move2, Move move3, Move move4) {
        super(name, Type.GROUND, health, attack, defense, special, move1, move2, move3, move4);
    }
}
